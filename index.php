<?php
  ...
  $result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCyXUJ8WH73iPOaWx_C8mpxw&key=#############');
  ...
  // Latest video
    $result = get_CURL('https://www.googleapis.com/youtube/v3/search?maxResults=1&order=date&part=snippet&channelId=UCyXUJ8WH73iPOaWx_C8mpxw&key=#############');
                ...
                <div class="col-md-5">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="g-ytsubscribe" data-channelid="UCyXUJ8WH73iPOaWx_C8mpxw" data-layout="default" data-count="default"></div>
                        </div>
                    </div>
